...
- **Done:** Phase 6 COMPLETE (2026-09-25) — `GET /api/analytics/summary` + value/human-hours-saved (explicit estimates only, ADR-0008) + dashboard Analytics honesty.
- **In progress:** nothing — MVP feature phases 0–6 landed; Antonio-blocked items remain (demo verdict, live BYOK, Phase 2 real-daemon).
