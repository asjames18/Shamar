...
- **Done (this PR):** SDK lifecycle methods (`pause`/`resume`/`retire`/`clone`) — good-first-issue 07. MVP feature phases 0–6 landed; Antonio-blocked items remain (demo verdict, live BYOK, Phase 2 real-daemon).
