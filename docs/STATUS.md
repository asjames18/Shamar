...
_Last updated: 2026-09-25 ~12:25 EDT.
...
- **This PR:** `feat/examples-python-client` — stdlib-only Python `examples/register-and-report.py` + `examples/README.md` (good-first-issue 04).
...
Tests 115/115 — lint clean — typecheck clean — build clean (verified 2026-09-25 ~12:25 EDT; GFI 04 adds example only, no test delta).
