...
_Last updated: 2026-09-25 ~12:35 EDT.
...
- **This PR:** `feat/seed-script-reset-flag` — `scripts/seed-demo.js --reset` (good-first-issue 05).
...
Tests 115/115 — lint clean — typecheck clean — build clean (verified 2026-09-25 ~12:35 EDT; GFI 05 seed script only, no test delta).
